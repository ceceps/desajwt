...
@if(isset($media))
   @foreach($media as $data)
    ...
    switch($data->parent_table){
        case 'r_desawisata':
        $folder = 'data-desawisata';
        break;
        case 'r_desawisata_atraksi':
        $folder = 'data-atraksi';
        break;
        case 'r_desawisata_fasilitas':
        $folder = 'data-fasilitas';
        break;
        case 'r_desawisata_kelsos':
        $folder = 'data-kelsos';
        break;
        case 'r_desawisata_jenis_usaha':
        $folder = 'data-jenis-usaha';
        break;
        case 'r_artikel':
        $folder = 'data-artikel';
        break;
        case 'r_profildesa':
        $folder = 'data-profildesa';
        break;
      }

       $url = Storage::url($folder.'/'.$data->filename);
           ...
           <div class="post-wrap">
             <div class="post-content">
               <div class="page-title reset">
                 <a href="{{ route('galeri.foto')}}"><div class="page-category">
                   {{ __('Foto') }}
                 </div>
                </a>
               ...
               <div class="post-entry">
                ...
                <img src="{{ asset($foto) }}" alt="{{ str_limit($konten,0,50) }}" class="img-fluid" >
                </div>
                 <p> {!! nl2br($konten) !!}</p>
               </div>
