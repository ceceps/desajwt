        ...
        <div class="auth-page">
            <div class="auth-screen">
                <div class="top-auth">
                    ...
                    <h1>Bantuan dan Dukungan, <span>Desa Wisata Jabar</span></h1>
                </div>
                <div class="mid-auth">
                    @if ($errors->any())
                    ...
                    @endif
                        <p class="card-text">
                            Silahkan hubungi ke <strong>desawisatajabar@gmail.com</strong> jika terjadi masalah teknis ketika Login/Daftar
                        </p>
                </div>
