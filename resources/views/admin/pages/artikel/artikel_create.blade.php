...
@section('content')
    @if(!empty($artikel))
        @foreach ($artikel as $data)
            @php
                ...
                $judul = (Input::old('judul')!==null)?Input::old('judul'):$data->judul;
                $alt_foto = (Input::old('alt_foto')!==null)?Input::old('alt_foto'):$data->alt_foto;
                $slug = (Input::old('slug')!==null)?Input::old('slug'):$data->slug;
                $ktgr = $data->kategori_id;
                $konten = (Input::old('konten')!==null)?Input::old('konten'):$data->konten;
                $status = $data->status;

                if (count($data->Media)>0){
                    $foto = config('desawisata.PATH_IMAGE_ARTIKEL').$data->Media[0]['filename'];
                }else
    ...
    @else
        @php
            ...
            $ktgr = (Input::old('kategori_id')!==null)?Input::old('kategori_id'):'';
...
<div class="dashboard-content">
    <div class="dashboard-inner">
        <div class="container-fluid">
            ...
            <form class="form-custom has-category" action="{{ route($action) }}" method="POST" id="form-artikel"
                  ...
                  -->
                        ...
                        <div class="form-group has-two-fields">
                                ...
                                <div class="category-field" >
                                        ...
                                        <input name="fotoartikel" class="form-control" id="fotoartikel" type="file">
                                </div>
                                <div class="category-field" >
                        ...
                        <div class="form-group has-two-fields">
                            <div class="form-category-entry">
                                ...
                                <div class="category-field">
                                    ...
                                    <input type="text" name="tag" max-width="4" class="form-control" placeholder="Tag ditulis dan dipisahkan dengan koma" value="{{ old('tag') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group has-two-fields">
