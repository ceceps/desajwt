...
<div class="dashboard-wizard" style="padding:10px">
    <ul class="submit-steps">
        ...
        <li class="active">&raquo;Statistik</li>
        <li>Bantuan</li>
        <li>Penghargaan</li>
    </ul>
    @include('admin.partial.message')
    <form id="formdesawisataprofil" class="form-custom has-category repeater" action="{{ route('desawisata.store.stat',$idprofil) }}" data-toggle="validator" role="form" method="post" enctype="multipart/form-data">
        @csrf
        @include('admin.pages.desawisata.form.statistik')
        <!-- untuk progress bar -->
        <input type="button" class="btn btn-default" value="Kembali" id="kembali" onclick="javascript:location.href='{{ route('desawisata.create.promosi',$idprofil) }}'">
