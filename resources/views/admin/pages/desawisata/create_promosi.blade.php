...
<div class="dashboard-wizard" style="padding-left:20px">
    <ul class="submit-steps">
        ...
        <li>Aksesibilitas</li>
        <li>Fasilitas</li>
        <li class="active">&raquo; Promosi</li>
    ...
    <form action="{{ route('desawisata.store.promosi',$idprofil) }}" method="POST" id="formcreatepromosi" class="form-custom has-category repeater" role="form" enctype="text/plain" autocomplete="off">
        @csrf
        @include('admin.pages.desawisata.form.promosi')
        <input type="button" class="btn" value="Kembali" onclick="javascript:location.href='{{ route('desawisata.create.fasilitas',$idprofil) }}'">
