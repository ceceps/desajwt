...
<script>
                                          ...
                                          .on('click', function(){
                                            ...
                                            $('#formdesawisata').formValidation({
                                                        ...
                                                        $.each(params, function (i, val) {
                                                           ...
                                                           var imgFotoProfil = $('#fotodesawisata').get(0).files[0];
                                                           formData.append('fotodesawisata', imgFotoProfil);
    ...
    $('#smartwizard').smartWizard({
     ...
     //state awal btn finish disabled
    ...
    function onFinishCallback(objs, context){
        if(validateAllSteps()){
            //$('form').submit();
            // $("#formdesawisata").submit(function(){
            // var form = new FormData($('#formdesawisata'));
            // console.table(form);
            // return false;
            // var url = '{{ route("api.desawisata.store.profil") }}';
            // // pakai JWT nantinya
  ...
  $("#smartwizard").on("showStep", function(e, anchorObject, stepNumber, stepDirection) {
    ...
    //Prev
    $("#smartwizard").on("endReset", function(e, anchorObject, stepNumber, stepDirection) {
