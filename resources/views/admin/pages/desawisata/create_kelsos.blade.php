...
<div class="dashboard-wizard" style="padding:10px">
    <ul class="submit-steps">
        ...
        <li> Fasilitas</li>
        <li>Promosi</li>
        <li  class="active">&raquo; Kelompok Sosial</li>
    ...
    <form id="formdesawisataprofil" class="form-custom has-category repeater" action="{{ route('desawisata.store.kelsos',$idprofil) }}" data-toggle="validator" role="form" method="post" enctype="multipart/form-data">
        @csrf
        @include('admin.pages.desawisata.form.kelompok_sosial')
        <!-- untuk progress bar -->
        <input type="button" class="btn btn-default" value="Kelompok" id="kembali" onclick="javascript:location.href='{{ route('desawisata.create.promosi',$idprofil) }}'">
...
<script>
    ...
    var iKelsos=1;
        ...
        $('.select-jenis-kelsos').select2({
            placeholder:'Jenis Kelompok Sosial',
            allowClear: true,
            ajax: {
