    ...
    <div class="container-fluid">
        <section class="base-content">
            <div class="panel clean">
                ...
                <form class="form-custom" action="{{ route('kategoriartikel.store') }}" method="post">
                        @csrf
                        <div class="form-group">
                            <label class="control-label">Nama Kategori<em class="asterix">*</em></label>
                        <input type="text" class="form-control" placeholder="contoh: batununggal" name="nama" value="">
                        @if($errors->has('nama'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="contoh: batununggal" name="slug">
                            @if($errors->has('slug'))
                            <span class="help-block error">
                                {{ $errors->first('slug') }}
                            </span>
